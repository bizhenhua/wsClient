...
public class ObjectFactory {
    ...
    private final static QName _Exception_QNAME = new QName("http://blog.coderecord.org/", "Exception");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://blog.coderecord.org/", name = "Exception")
